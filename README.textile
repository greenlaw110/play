...
1. "play new app" will not throw out exception if there are existsing models folder inside application-skel
2. #{form} tag now acception "id" and "class" params
3. all features in official v1.2.3 version
